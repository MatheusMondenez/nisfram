<!-- Navigation -->
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{url('/home')}}">NISFRAM</a>
        </div>
        <!-- Top Menu Items -->
        <ul class="nav navbar-right top-nav">
                        ...
                        <a href="#">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="media-heading"><strong>Matheus</strong>
                                    </h5>
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Matheus <b class="caret"></b></a>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li @if($title == 'Aulas') class="active" @endif>
                    <a href="{{ url('/aulas') }}"><i class="fa fa-fw fa-book"></i> Aulas</a>
                </li>
                <li @if($title == 'Chamadas') class="active" @endif>
                    <a href="{{ url('/chamadas') }}"><i class="fa fa-fw fa-check-square-o"></i> Chamadas</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
